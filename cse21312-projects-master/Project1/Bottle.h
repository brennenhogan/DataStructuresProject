...
public:
  ...
  * Pre-conditions : const Bottle& comp
  * Post-conditions: bool
  * Over rides < operator to see if the first Bottle name comes earlier in the alphabet 
  ********************************************/
  ...
  * Pre-conditions : const Bottle& comp
  * Post-conditions: bool
  * Over rides > operator to see if the first Bottle name comes later in the alphabet 
  ********************************************/
  bool operator> (const Bottle& comp);
  ...
  * Pre-conditions : const Bottle& comp
  * Post-conditions: bool
  * Overrides == operator to see if the Bottle names are the same 
  ********************************************/
  bool operator== (const Bottle& comp);
  ...
  * Pre-conditions : const Bottle& comp
  * Post-conditions: bool
  * Overrides != operator to see if the names are different 
  ********************************************/
  bool operator!= (const Bottle& comp); 
